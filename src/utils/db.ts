...
export async function saveProject(project: SavedProject): Promise<void> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => reject(new Error(request.error?.message ?? 'Failed to save project'))
...
export async function loadProject(id: string): Promise<SavedProject | undefined> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => reject(new Error(request.error?.message ?? 'Failed to load project'))
...
export async function listProjects(): Promise<ProjectMetadata[]> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => reject(new Error(request.error?.message ?? 'Failed to list projects'))
		request.onsuccess = () => {
...
export async function deleteProject(id: string): Promise<void> {
	...
	return new Promise((resolve, reject) => {
		...
		request.onerror = () => reject(new Error(request.error?.message ?? 'Failed to delete project'))
		request.onsuccess = () => resolve()
	})
}
